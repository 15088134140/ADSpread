...
const translations = {
    ja: {
        ...
        auditTime: '審査時間',
        rejectReason: '却下理由',
        enterRejectReason: '却下理由を入力してください（10文字以上）',
        pass: '通過',
        reject: '却下',
        auditAction: '審査操作',
    ...
    zh: {
        ...
        auditTime: '审核时间',
        rejectReason: '驳回原因',
        enterRejectReason: '请输入驳回原因（至少10字）',
        pass: '通过',
        reject: '驳回',
        auditAction: '审核操作',
    ...
    en: {
        ...
        other: 'Other',
        selectCategory: 'Please select industry category',
        address: 'Address',
        ...
        allAuditStatus: 'All Status',
        pending: 'Pending',
        approved: 'Approved',
        rejected: 'Rejected',
        audit: 'Audit',
        auditMaterial: 'Material Audit',
        auditInfo: 'Audit Info',
        auditor: 'Auditor',
        auditTime: 'Audit Time',
        rejectReason: 'Reject Reason',
        enterRejectReason: 'Please enter reject reason (min 10 characters)',
        pass: 'Pass',
        reject: 'Reject',
